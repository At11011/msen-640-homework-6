...
\begin{enumerate}
  \item After careful synthesis, you finally manage to create a new
    ...
    \begin{enumerate}[(a.)]
      \item In preparation, you wish to recall the relationship
        ...
        \boxedanswer{
            ...
            \begin{align*}
                ...
                \Aboxed{\chi &= \frac{1}{2\phi_A - 1}\left(\ln \left[\frac{\phi_A}{1 - \phi_A}\right] + 2\right)}
            \end{align*}
        }
      ...
      \item  Without bothering to measure the initial volume fraction
        ...
        Plug into the above equation:
            ...
            \begin{align*}
                \chi &= \frac{1}{2X_A - 1}\left(\ln \left[\frac{X_A}{1 - X_A}\right] + 2\right) \\
                \chi &= \frac{1}{2(0.8) - 1}\left(\ln \left[\frac{0.8}{1 - 0.8}\right] + 2\right) \\
                \Aboxed{\chi &\approx 5.644}
            \end{align*}
        }
    ...
    \boxedanswer{
        ...
        We have two data points, at the first data point, the volume
        fraction is 0.8 at \SI{50}{\degree F} or \SI{274.816}{\kelvin},
        and 0.968 at \SI{35}{\degree F}. 
